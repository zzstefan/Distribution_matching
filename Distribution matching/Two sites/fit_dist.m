% Adjust the code, so it can accept different site names;
% Either within OASIS-3 or OASIS-3 versus ADNI2.

function [weight, params] = fit_dist(conn_mat, data, fea_index)
